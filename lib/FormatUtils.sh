...
format_calculate_dynamics_count() {
...
# Parameters: $1 - format [$2 - specifier array]
format_calculate_statics_length() {
...
format_calculate_literals_length() {
  ...
  FormatCalculateLiteralsLength=$((${#__format_calculate_literals_length__normalizedFormat} - (${#__format_calculate_literals_length__specifiers[@]} - ${#__format_calculate_literals_length__specifiers[@]})))
}
...
format_calculate_dynamics_length() {
...
format_calculate_autosize_length() {
  ...
  if [[ $__format_calculate_autosize_length__dynamicsCount -ne 0 && \
